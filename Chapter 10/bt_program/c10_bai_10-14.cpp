...
// Definition of countChars. The parameter strPtr is a pointer to a string.
// The parameter ch is a character that the function searches for in the string.
// The function returns the number of times the character appears in the string.
