...
int main()
{
    ...
    // Get a number and store it in the 'value' variable.
    getNum(value);
...
// Definition of getNum function.
// The parameter 'userNum' is a reference variable. The user is asked to enter a number, which is stored in 'userNum'.
...
// Definition of doubleNum function.
